...
function generateRandomPassword(length) {
  ...
  for (let i = 0; i < characters.length; i++) {
   randomIdex = Math.floor(Math.random() * characters.length);
    password += characters[randomIdex];
...
// Завдання 10
/**
 * Функція `estimateInvestment` оцінює прибуток від інвестицій з фіксованою річною процентною ставкою за задану
 *  кількість років.
 *
...
function isTotalPriceExceedsMaxPrice(products, maxPrice) {
  if (!Array.isArray(products)) {
    console.log("Помилка: перший аргумент має бути масивом.");
    return null;
  }
  if (typeof maxPrice !== "number") {
    console.log("Помилка: другий аргумент має бути числом.");
    return null;
  }
